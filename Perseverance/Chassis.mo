...
model Chassis
    ...
    summary_p_sw=0,icon_name = "modelica://Workspace/Resources/perseverance_icon.png");
...
equation
    ...
    connect(linkage.hubFlange1,hub_1) annotation(Line(points = {{-33.4,-40},{-33.4,-46},{-70,-46},{-70,-50}},color = {95,95,95}));
    connect(linkage.hubFlange2,hub_3) annotation(Line(points = {{-20,-40},{-20,-45},{0,-45},{0,-50}},color = {95,95,95}));
    connect(linkage.hubFlange3,hub_5) annotation(Line(points = {{-6.6,-39.86666666666667},{-6.6,-44},{70,-44},{70,-50}},color = {95,95,95}));
    connect(linkage.frame_a,differentialLinkage.frame_b1) annotation(Line(points = {{-20,-20},{-20,-14},{-36,-14},{-36,-10}},color = {95,95,95}));
    connect(linkage2.frame_a,differentialLinkage.frame_b2) annotation(Line(points = {{-20,20},{-20,16},{-36,16},{-36,10}},color = {95,95,95}));
    connect(hub_2,linkage2.hubFlange1) annotation(Line(points = {{-70,50},{-70,46},{-33.4,46},{-33.4,40}},color = {95,95,95}));
    connect(hub_4,linkage2.hubFlange2) annotation(Line(points = {{0,50},{0,45},{-20,45},{-20,40}},color = {95,95,95}));
    connect(hub_6,linkage2.hubFlange3) annotation(Line(points = {{70,50},{70,44},{-6.6,44},{-6.6,39.86666666666667}},color = {95,95,95}));
    connect(linkage.steer_front,steerFL) annotation(Line(points = {{-42,-24},{-86,-24},{-86,30},{-107.6,30}},color = {0,0,127}));
    connect(linkage.steer_rear,steerRL) annotation(Line(points = {{-42,-36},{-88,-36},{-88,-10},{-107.6,-10}},color = {0,0,127}));
    connect(linkage2.steer_front,steerFR) annotation(Line(points = {{-42,24},{-88,24},{-88,10},{-107.6,10}},color = {0,0,127}));
    connect(linkage2.steer_rear,steerRR) annotation(Line(points = {{-42,36},{-90,36},{-90,-30},{-107.6,-30}},color = {0,0,127}));
