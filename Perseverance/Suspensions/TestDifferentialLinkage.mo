...
model TestDifferentialLinkage
    ...
    parameter .Modelica.Units.SI.Position r0H_1[3] = {1.1151,1.1452,-0.00166} "Position of hub 1 relative frame_a";
    parameter .Modelica.Units.SI.Position r0H_2[3] = {-0.069879,1.2672,-0.001271} "Position of hub 2 relative frame_a";
    parameter .Modelica.Units.SI.Position r0H_3[3] = {-1.1449,1.1452,0.00162} "Position of hub 3 relative frame_a";
    parameter .Modelica.Units.SI.Position r0J[3] = {-0.50499,1.0291,-0.047127} "Position of front bogie joint relative frame_a";
    parameter .Modelica.Units.SI.Position r0S_1[3] = {1.13,1.0625,0.14587} "Position of front steer joint relative frame_a";
    parameter .Modelica.Units.SI.Position r0S_2[3] = {-1.13,1.0625,0.14587} "Position of rear steer joint relative frame_a";
    ...
    .Modelon.Blocks.Sources.SinglePeriodSine singlePeriodSine(amplitude = 0.25,f = 0.5) annotation(Placement(transformation(extent = {{-80,-80},{-60,-60}},origin = {0,0},rotation = 0)));
equation
