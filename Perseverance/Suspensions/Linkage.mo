...
model Linkage
    ...
    .Modelica.Mechanics.MultiBody.Visualizers.FixedShape frontBogieArmVis(height = 1,width = 1,length = left,shapeType = "modelica://Workspace/Resources/Perseverance_front_bogie_arm.glb",lengthDirection = {0,1,0},widthDirection = {-1,0,0},extra = 1) annotation(Placement(transformation(extent = {{40.0,70.0},{60.0,90.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Mechanics.MultiBody.Visualizers.FixedShape rearBogieArmVis(widthDirection = {-1,0,0},lengthDirection = {0,1,0},shapeType = "modelica://Workspace/Resources/Perseverance_rear_bogie_arm.glb",length = left,width = 1,height = 1,r_shape = -r0J,extra = 1) annotation(Placement(transformation(extent = {{-38.0,24.0},{-58.0,44.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Mechanics.MultiBody.Visualizers.FixedShape rearWheelMountVis(r_shape = -r0S_2,height = 1,width = 1,length = left,shapeType = "modelica://Workspace/Resources/Perseverance_rear_wheel_mount.glb",lengthDirection = {0,1,0},widthDirection = {-1,0,0},extra = 1) annotation(Placement(transformation(extent = {{-56.0,-50.0},{-36.0,-30.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Mechanics.MultiBody.Visualizers.FixedShape frontWheelMountVis(widthDirection = {-1,0,0},lengthDirection = {0,1,0},shapeType = "modelica://Workspace/Resources/Perseverance_front_wheel_mount.glb",length = left,width = 1,height = 1,r_shape = -r0S_1,extra = 1) annotation(Placement(transformation(extent = {{120.0,-30.0},{100.0,-10.0}},origin = {0.0,0.0},rotation = 0.0)));
