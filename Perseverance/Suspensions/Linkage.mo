...
model Linkage
    ...
    .VehicleDynamics.Vehicles.Chassis.Suspensions.Linkages.Links.Link rearBogieArm1 (r0B = (r0S_2 - r0J) .* {1,left,1},visualize = false)annotation(Placement(transformation(extent = {{-10.0,-10.0},{10.0,10.0}},origin = {-58.0,10.0},rotation = -180.0)));
    .VehicleDynamics.Vehicles.Chassis.Suspensions.Linkages.Links.Link rearBogieArm2 (r0B = (r0H_2 - r0J) .* {1,left,1},visualize = false)annotation(Placement(transformation(extent = {{-30.0,-22.0},{-10.0,-2.0}},origin = {0.0,0.0},rotation = 0.0)));
    .VehicleDynamics.Vehicles.Chassis.Suspensions.Linkages.Links.Link frontBogieArm2 (r0B = (r0S_1 - r0BJ) .* {1,left,1},visualize = false)annotation(Placement(transformation(extent = {{40.0,30.0},{60.0,50.0}},origin = {0.0,0.0},rotation = 0.0)));
    .VehicleDynamics.Vehicles.Chassis.Suspensions.Linkages.Links.Link frontBogieArm1 (r0B = (r0J - r0BJ) .* {1,left,1},visualize = false)annotation(Placement(transformation(extent = {{-10.0,-10.0},{10.0,10.0}},origin = {10.0,40.0},rotation = -180.0)));
    ...
    .VehicleDynamics.Vehicles.Chassis.Suspensions.Linkages.Links.Link rearWheelMount(r0B = (r0H_3 - r0S_2) .* {1,left,1},visualize = false) annotation(Placement(transformation(extent = {{-10.0,-10.0},{10.0,10.0}},origin = {-134.0,-40.0},rotation = -90.0)));
    .VehicleDynamics.Vehicles.Chassis.Suspensions.Linkages.Links.Link frontWheelMount(r0B = (r0H_1 - r0S_1) .* {1,left,1},visualize = false) annotation(Placement(transformation(extent = {{-10.0,-10.0},{10.0,10.0}},origin = {134.0,-40.0},rotation = -90.0)));
    ...
    .Modelon.Mechanics.MultiBody.Parts.FixedTranslation toBogieJoint(visualize = false,r = r0BJ .* {1,left,1}) annotation(Placement(transformation(extent = {{-10.0,-10.0},{10.0,10.0}},origin = {0.0,60.0},rotation = -90.0)));
    ...
    .Modelica.Mechanics.MultiBody.Visualizers.FixedShape rearBogieArmVis(widthDirection = {-1,0,0},lengthDirection = {0,1,0},shapeType = "modelica://Perseverance/Resources/Perseverance_rear_bogie_arm.glb",length = left,width = 1,height = 1,r_shape = -r0J .* {1,left,1},extra = 1) annotation(Placement(transformation(extent = {{-38.0,24.0},{-58.0,44.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Mechanics.MultiBody.Visualizers.FixedShape rearWheelMountVis(r_shape = -r0S_2 .* {1,left,1},height = 1,width = 1,length = left,shapeType = "modelica://Perseverance/Resources/Perseverance_rear_wheel_mount.glb",lengthDirection = {0,1,0},widthDirection = {-1,0,0},extra = 1) annotation(Placement(transformation(extent = {{-56.0,-50.0},{-36.0,-30.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Mechanics.MultiBody.Visualizers.FixedShape frontWheelMountVis(widthDirection = {-1,0,0},lengthDirection = {0,1,0},shapeType = "modelica://Perseverance/Resources/Perseverance_front_wheel_mount.glb",length = left,width = 1,height = 1,r_shape = -r0S_1 .* {1,left,1},extra = 1) annotation(Placement(transformation(extent = {{120.0,-30.0},{100.0,-10.0}},origin = {0.0,0.0},rotation = 0.0)));
...
equation
    connect(hub_2.hubFlange,hubFlange2) annotation(Line(points = {{2.220446049250313e-15,-80},{2.220446049250313e-15,-100},{0,-100}},color = {95,95,95}));
    connect(hub_3.hubFlange,hubFlange3) annotation(Line(points = {{-134,-80.66666666666667},{-134,-98.66666666666667}},color = {95,95,95}));
    connect(hub_1.hubFlange,hubFlange1) annotation(Line(points = {{134,-80},{134,-100}},color = {95,95,95}));    connect(frontBogieArmVis.frame_a,frame_a) annotation(Line(points = {{40,80},{0,80},{0,100}},color = {95,95,95}));
    ...
    connect(rearWheelMount.frame_b,hub_3.frame_a) annotation(Line(points = {{-134,-50},{-134,-60.66666666666667}},color = {95,95,95}));
    connect(rearWheelMountVis.frame_a,rearWheelMount.frame_a) annotation(Line(points = {{-56,-40},{-62,-40},{-62,-26},{-134,-26},{-134,-30}},color = {95,95,95}));
    connect(rearWheelMount.frame_a,rearSteerJoint.frame_b) annotation(Line(points = {{-134,-30},{-134,-26},{-80,-26},{-80,-20}},color = {95,95,95}));
    ...
    connect(toBogieJoint.frame_a,frame_a) annotation(Line(points = {{-2.220446049250313e-15,70},{0,70},{0,100}},color = {95,95,95}));
    connect(frontBogieArm1.frame_a,toBogieJoint.frame_b) annotation(Line(points = {{20,40},{30,40},{30,50},{2.220446049250313e-15,50}},color = {95,95,95}));
    connect(frontBogieArm2.frame_a,toBogieJoint.frame_b) annotation(Line(points = {{40,40},{30,40},{30,50},{2.220446049250313e-15,50}},color = {95,95,95}));
