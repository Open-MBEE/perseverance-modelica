...
model TestLinkage
    ...
    .Perseverance.Wheels.Standard wheel_ (visualization(visualize_contact_forces = false,visualize_tread_texture = false))annotation(Placement(transformation(extent = {{-10.0,-10.0},{10.0,10.0}},origin = {-40.0,-30.0},rotation = 90.0)));
    .Perseverance.Wheels.Standard wheel_2 (visualization(visualize_contact_forces = false,visualize_tread_texture = false))annotation(Placement(transformation(extent = {{-10.0,-10.0},{10.0,10.0}},origin = {-10.0,-30.0},rotation = 90.0)));
    .Perseverance.Wheels.Standard wheel_3 (visualization(visualize_tread_texture = false,visualize_contact_forces = false))annotation(Placement(transformation(extent = {{-10.0,-10.0},{10.0,10.0}},origin = {20.0,-30.0},rotation = 90.0)));
