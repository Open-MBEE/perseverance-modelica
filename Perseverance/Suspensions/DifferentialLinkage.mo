...
model DifferentialLinkage
    ...
    parameter .Modelica.Units.SI.Position r0C[3]  = {-0.142,0,1.1552} "Position of diff revolute joint relative vehicleFrame";
    parameter .Modelica.Units.SI.Position r0D1[3]  = {-0.142,0.63799,1.1552} "Position of left outer diff joint relative vehicleFrame" annotation(Evaluate=false);
    parameter .Modelica.Units.SI.Position r0D2[3]   = r0D1 .* {1,-1,1} "Position of right outer diff joint relative vehicleFrame";
    parameter .Modelica.Units.SI.Position r0J1[3]  = {0.214,0.65699,0.85684} "Position of left bogie revolute joint relative vehicleFrame";
    parameter .Modelica.Units.SI.Position r0J2[3]   = r0J1 .* {1,-1,1} "Position of right bogie revolute joint relative vehicleFrame";
    ...
    .Modelon.Mechanics.MultiBody.Parts.FixedTranslation toRightFrame(r = r0J2,visualize = false) annotation(Placement(transformation(extent = {{0.0,70.0},{-20.0,90.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    parameter .Modelica.Units.SI.Position r0L1[3] = {0.214,0.64069,1.1678} "Position of left top lever joint relative vehicleFrame";
    parameter .Modelica.Units.SI.Position r0L2[3]  = r0L1 .* {1,-1,1} "Position of right top lever joint relative vehicleFrame";
...
equation
    ...
    connect(leftDiffLinkVis.frame_a,leftLinkage.frame_d) annotation(Line(points = {{0,-62},{-22,-62},{-22,-60}},color = {95,95,95}));
    connect(arm2.frame_b,rightLinkage.frame_b) annotation(Line(points = {{-9.999999999999998,30},{-9.999999999999998,50},{-22,50}},color = {95,95,95}));
    connect(rightDiffLinkVis.frame_a,rightLinkage.frame_d) annotation(Line(points = {{0,62},{-24,62},{-24,60}},color = {95,95,95}));
    connect(toLeftFrame.frame_a,frame_b1) annotation(Line(points = {{0,-80},{40,-80},{40,-100}},color = {95,95,95}));
    connect(leftTopBogieJointVis.frame_a,toLeftFrame.frame_a) annotation(Line(points = {{60,-80},{0,-80}},color = {95,95,95}));
    connect(toLeftFrame.frame_b,leftLinkage.frame_c) annotation(Line(points = {{-20,-80},{-38,-80},{-38,-60}},color = {95,95,95}));
    connect(toRightFrame.frame_a,frame_b2) annotation(Line(points = {{0,80},{40,80},{40,100}},color = {95,95,95}));
    connect(rightTopBogieJointVis.frame_a,toRightFrame.frame_a) annotation(Line(points = {{60,80},{0,80}},color = {95,95,95}));
    connect(toRightFrame.frame_b,rightLinkage.frame_c) annotation(Line(points = {{-20,80},{-40,80},{-40,60}},color = {95,95,95}));
    connect(toLeftLinkage.frame_a,frame_a) annotation(Line(points = {{-80,-50},{-94,-50},{-94,0},{-100,0}},color = {95,95,95}));
    connect(toLeftLinkage.frame_b,leftLinkage.frame_a) annotation(Line(points = {{-60,-50},{-40,-50}},color = {95,95,95}));
    connect(toRightLinkage.frame_a,frame_a) annotation(Line(points = {{-80,50},{-94,50},{-94,0},{-100,0}},color = {95,95,95}));
    connect(toRightLinkage.frame_b,rightLinkage.frame_a) annotation(Line(points = {{-60,50},{-42,50}},color = {95,95,95}));
    connect(arm1.frame_a,centerJoint.frame_b) annotation(Line(points = {{-10.000000000000002,-10},{-10.000000000000002,0},{-40,0}},color = {95,95,95}));
    connect(arm2.frame_a,centerJoint.frame_b) annotation(Line(points = {{-10.000000000000002,10},{-10.000000000000002,0},{-40,0}},color = {95,95,95}));
    connect(diffArmVis.frame_a,centerJoint.frame_b) annotation(Line(points = {{0,0},{-40,0}},color = {95,95,95}));
    connect(toCenterJoint.frame_a,frame_a) annotation(Line(points = {{-90,0},{-100,0}},color = {95,95,95}));
    connect(toCenterJoint.frame_b,centerJoint.frame_a) annotation(Line(points = {{-70,0},{-60,0}},color = {95,95,95}));
