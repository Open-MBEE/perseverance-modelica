...
model DifferentialLinkage
    ...
    .Modelica.Mechanics.MultiBody.Visualizers.FixedShape diffArmVis(extra = 1,r_shape = -r0C,height = 1,width = 1,length = 1,shapeType = "modelica://Workspace/Resources/Perseverance_diff_arm.glb",lengthDirection = {0,1,0},widthDirection = {-1,0,0}) annotation(Placement(transformation(extent = {{0.0,-10.0},{20.0,10.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Mechanics.MultiBody.Visualizers.FixedShape rightTopBogieJointVis(extra = 1,height = 1,width = 1,length = -1,shapeType = "modelica://Workspace/Resources/Perseverance_top_bogie_joint.glb",lengthDirection = {0,1,0},widthDirection = {-1,0,0}) annotation(Placement(transformation(extent = {{60.0,70.0},{80.0,90.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .Modelica.Mechanics.MultiBody.Visualizers.FixedShape rightDiffLinkVis(widthDirection = {-1,0,0},lengthDirection = {0,1,0},shapeType = "modelica://Workspace/Resources/Perseverance_diff_link.glb",length = -1,width = 1,height = 1,extra = 1,r_shape = -r0D2) annotation(Placement(transformation(extent = {{0.0,52.0},{20.0,72.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Mechanics.MultiBody.Visualizers.FixedShape leftDiffLinkVis(extra = 1,height = 1,width = 1,length = 1,shapeType = "modelica://Workspace/Resources/Perseverance_diff_link.glb",lengthDirection = {0,1,0},widthDirection = {-1,0,0},r_shape = -r0D1) annotation(Placement(transformation(extent = {{0.0,-72.0},{20.0,-52.0}},origin = {0.0,0.0},rotation = 0.0)));
