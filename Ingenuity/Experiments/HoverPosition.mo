...
model HoverPosition
    extends .Ingenuity.Experiments.Templates.Minimal(
        redeclare replaceable .Ingenuity.HelicopterPitchRoll helicopter(redeclare replaceable .Ingenuity.Controllers.AltitudePositionAnglesControl controller),
    ...
    replaceable .Modelica.Blocks.Sources.Trapezoid x_ref(amplitude = 0.5,rising = 10,width = 10,falling = 10,period = 40,nperiod = 1,startTime = 4) constrainedby .Modelica.Blocks.Interfaces.SignalSource annotation(Placement(transformation(extent = {{-99.99746866067566,54.002531339324335},{-88.00253133932434,65.99746866067566}},origin = {0.0,0.0},rotation = 0.0)));
    replaceable .Modelica.Blocks.Sources.Sine y_ref(amplitude = 0.5,freqHz = 0.05,startTime = 6) constrainedby .Modelica.Blocks.Interfaces.SignalSource annotation(Placement(transformation(extent = {{-99.99746866067566,34.002531339324335},{-88.00253133932434,45.997468660675665}},origin = {0.0,0.0},rotation = 0.0)));
