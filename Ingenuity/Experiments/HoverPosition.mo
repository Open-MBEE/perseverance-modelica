...
model HoverPosition
    ...
    replaceable .Modelica.Blocks.Sources.Sine y_ref(amplitude = 0.5,f = 0.05,startTime = 6) constrainedby .Modelica.Blocks.Interfaces.SignalSource annotation(Placement(transformation(extent = {{-99.99746866067566,34.002531339324335},{-88.00253133932434,45.997468660675665}},origin = {0.0,0.0},rotation = 0.0)));
