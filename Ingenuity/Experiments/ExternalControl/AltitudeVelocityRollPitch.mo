...
model AltitudeVelocityRollPitch
    ...
    .Modelica.Blocks.Sources.Clock clock annotation(Placement(transformation(extent = {{-100.00652496568843,13.993475034311572},{-87.99347503431157,26.006524965688428}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .Modelon.DataAccess.Tables.ModelonTable1D vxTable(yfactor = 1,xfactor = 1,variableName = "vx") annotation(Placement(transformation(extent = {{-80.4985026664197,-46.4985026664197},{-67.5014973335803,-33.5014973335803}},rotation = 0.0,origin = {0.0,0.0})));
    .Modelon.DataAccess.Tables.ModelonTable1D vyTable(variableName = "vy",xfactor = 1,yfactor = 1) annotation(Placement(transformation(extent = {{-80.4985026664197,-66.4985026664197},{-67.5014973335803,-53.5014973335803}},rotation = 0.0,origin = {0.0,0.0})));
equation
