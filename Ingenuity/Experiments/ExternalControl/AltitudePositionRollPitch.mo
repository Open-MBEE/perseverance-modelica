...
model AltitudePositionRollPitch
    ...
    .Modelica.Blocks.Sources.Clock clock annotation(Placement(transformation(extent = {{-100.00652496568843,-6.006524965688428},{-87.99347503431157,6.006524965688428}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelon.DataAccess.Tables.ModelonTable1D altitudeTable(yfactor = 1,xfactor = 1,variableName = "altitude",tableType = .Modelon.Types.TableType.AccessArray) annotation(Placement(transformation(extent = {{-80.4985026664197,13.501497333580303},{-67.5014973335803,26.498502666419697}},rotation = 0.0,origin = {0.0,0.0})));
    .Modelon.DataAccess.Tables.ModelonTable1D rollTable(variableName = "roll",xfactor = 1,yfactor = .Modelica.Constants.pi/180.0) annotation(Placement(transformation(extent = {{-80.4985026664197,-6.4985026664196965},{-67.5014973335803,6.4985026664196965}},rotation = 0.0,origin = {0.0,0.0})));
    .Modelon.DataAccess.Tables.ModelonTable1D pitchTable(yfactor = .Modelica.Constants.pi / 180.0,xfactor = 1,variableName = "pitch") annotation(Placement(transformation(extent = {{-80.4985026664197,-26.498502666419697},{-67.5014973335803,-13.501497333580303}},rotation = 0.0,origin = {0.0,0.0})));
    .Modelon.DataAccess.Tables.ModelonTable1D xTable(tableType = .Modelon.Types.TableType.AccessArray,variableName = "x",xfactor = 1,yfactor = 1) annotation(Placement(transformation(extent = {{-80.4985026664197,53.5014973335803},{-67.5014973335803,66.4985026664197}},rotation = 0.0,origin = {0.0,0.0})));
    .Modelon.DataAccess.Tables.ModelonTable1D yTable(yfactor = 1,xfactor = 1,variableName = "y",tableType = .Modelon.Types.TableType.AccessArray) annotation(Placement(transformation(extent = {{-80.4985026664197,33.5014973335803},{-67.5014973335803,46.4985026664197}},rotation = 0.0,origin = {0.0,0.0})));
equation
