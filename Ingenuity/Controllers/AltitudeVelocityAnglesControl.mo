...
model AltitudeVelocityAnglesControl
    ...
    .Modelon.Blocks.Control.LimPID limPIDVy(Td = 0.01,Ti = 0.1,with_FF = false,yMax = 10,k = -0.2,controllerType = Modelica.Blocks.Types.SimpleController.PID) annotation(Placement(transformation(extent = {{-46.42942926203107,-6.429429262031067},{-33.57057073796893,6.429429262031067}},origin = {0.0,0.0},rotation = 0.0)));
...
equation
    ...
    connect(limPIDHeave.u_s,position_ref[3]) annotation(Line(points = {{-81.80284996004923,-72},{-92,-72},{-92,40},{-112,40}},color = {0,0,127}));
    ...
    connect(limPIDVx.u_s,velocity_ref[1]) annotation(Line(points = {{-84.39234078735379,66},{-96,66},{-96,0},{-110,0}},color = {0,0,127}));
    connect(limPIDVx.u_m,velocity[1]) annotation(Line(points = {{-76,57.60765921264622},{-76,-32},{40,-32},{40,-110}},color = {0,0,127}));
    connect(velocity_ref[2],limPIDVy.u_s) annotation(Line(points = {{-110,0},{-47.71531511443728,0}},color = {0,0,127}));
    connect(velocity[2],limPIDVy.u_m) annotation(Line(points = {{40,-110},{40,-26},{-40,-26},{-40,-7.715315114437281}},color = {0,0,127}));
    ...
    connect(limPIDVy.y,switchRoll.u3) annotation(Line(points = {{-32.927627811765824,0},{-26.932673026000955,0},{-26.932673026000955,5.109718388684211},{-15.664577583026317,5.109718388684211}},color = {0,0,127}));
...
end AltitudeVelocityAnglesControl;
